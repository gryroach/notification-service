...
# project
from src.domain.interfaces.repositories import IReadRepository, IWriteRepository
...
class BaseCRUDRepository(
    Generic[ModelType, CreateSchemaType, UpdateSchemaType], IReadRepository[ModelType], IWriteRepository[ModelType]
):
